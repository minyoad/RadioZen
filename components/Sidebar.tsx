...
import { Radio, Heart, ListMusic, Settings, User, Mic2, PlusCircle } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, onAddStation }) => {
  const menuItems = [
